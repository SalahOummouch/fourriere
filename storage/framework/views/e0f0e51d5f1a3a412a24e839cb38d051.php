                                        ...
                                        <tr class="white-space-no-wrap">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center">
                                                    ...
                                                    <!-- Icône Relancer -->
                                                    <a href="<?php echo e(route('plaques.relance', $plaque->id)); ?>" class="relancer" data-id="<?php echo e($plaque->id); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Relancer">
