    ...
    <div class="data-scrollbar" data-scroll="1">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="side-menu">
                <li class="<?php echo e(request()->routeIs('index') ? 'active' : ''); ?> sidebar-layout">
                    <a href="<?php echo e(route('index')); ?>" class="svg-icon">
                        <i>
                ...
                <li class="sidebar-layout">
                    <a href="<?php echo e(route('plaques.archives')); ?>" class="svg-icon">
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" viewBox="0 0 24 24" stroke="currentColor" fill="none">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<?php /**PATH C:\Users\TOSHIBA\Desktop\developement with Salah\fourriere\fourriere\resources\views/partials/_body_sidebar.blade.php ENDPATH**/ ?>