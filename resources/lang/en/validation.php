...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Lignes de validation en français
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes contiennent les messages d'erreur par défaut utilisés
    | par la classe de validation de Laravel. Vous êtes libre de modifier
    | ces messages en fonction des besoins de votre application.
    |
    */
    ...
    'unique' => 'La valeur du champ :attribute a déjà été utilisée.',
