                        ...
                        <div class="col-md-9">
                            ...
                            @csrf
                                <div class="col-md-6 mb-3">
                                    <label for="Text1" class="form-label fw-bold text-muted text-uppercase">
                                        Numero de plaque</label>
                                    <input name="plaqueNumber" type="text" class="form-control" id="plaqueNumber" placeholder="Ex : AA-123-AA">
                                </div>
