 <x-app-layout :isMasonry="true">
     <div class="container-fluid">
         <div class="row">
             <div class="col-sm-6 col-md-6 col-lg-3">
                 <div class="card mb-3">
                     <img src="{{ asset('images/page-img/card.jpg') }}" class="card-img-top rounded-top" alt="#"
                         loading="lazy">
                     <div class="card-body">
                 ...
                 <div class="card mb-3">
                     ...
                     <div class="card-body">
                         <blockquote class="blockquote">
                             <p class="">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
                                 erat a ante.</p>
         ...
         <div class="row">
             <div class="col-sm-4">
                 <div class="card mb-3">
                     <img src="{{ asset('images/page-img/card.jpg') }}" class="card-img-top rounded-top"
                         alt="#" loading="lazy">
                     <div class="card-body">
                         <h4 class="card-title">Card title</h4>
             ...
             <div class="col-sm-4">
                 <div class="card mb-3">
                     ...
                     <img src="{{ asset('images/page-img/card.jpg') }}" class="card-img-top rounded-bottom"
                         alt="#" loading="lazy">
                 </div>
             </div>
             <div class="col-sm-4">
                 <div class="card bg-dark text-white mb-3">
                     <img src="{{ asset('images/page-img/card.jpg') }}" class="card-img rounded" alt="#"
                         loading="lazy">
         ...
         <div class="row">
             <div class="col-sm-12">
                 <h4 class="mt-4 mb-3">Horizontal Card</h4>
             </div>
             <div class="col-lg-6">
                 <div class="card mb-3">
                     <div class="row no-gutters">
                         <div class="col-md-4">
                             <img src="{{ asset('/images/page-img/08.jpg') }}"class="card-img rounded" alt="#"
                                 loading="lazy">
                         </div>
                         <div class="col-md-8">
                             <div class="card-body">
             ...
             <div class="col-lg-6">
                 <div class="card mb-3">
                     <div class="row no-gutters flex-row-reverse">
                         <div class="col-md-4">
                             <img src="{{ asset('/images/page-img/09.jpg') }}"class="card-img rounded" alt="#"
                                 loading="lazy">
                         </div>
                         <div class="col-md-8">
         ...
         <div class="row">
             <div class="col-sm-12">
                 <h4 class="mt-4 mb-3">Card Colored Styles</h4>
             </div>
             <div class="col-lg-4">
         ...
         <div class="row">
             <div class="col-sm-12">
                 <h4 class="mt-4 mb-3">Border Card</h4>
             </div>
             <div class="col-lg-4">
         ...
         <div class="row">
             <div class="col-sm-12">
                 <h4 class="mt-4 mb-3">Card groups</h4>
             </div>
             <div class="col-sm-12">
                 <div class="card-group mb-3">
                     <div class="card">
                         <img src="{{ asset('images/page-img/card.jpg') }}" class="card-img-top rounded-start"
                             alt="#">
                         <div class="card-body">
                             <h4 class="card-title">Card title</h4>
                     ...
                     <div class="card">
                         <img src="{{ asset('images/page-img/card.jpg') }}" class="card-img-top" alt="#">
                         <div class="card-body">
                             <h4 class="card-title">Card title</h4>
                     ...
                     <div class="card">
                         <img src="{{ asset('images/page-img/card.jpg') }}" class="card-img-top rounded-end"
                             alt="#">
                         <div class="card-body">
                             <h4 class="card-title">Card title</h4>
                             <p class="card-text">This is a wider card with supporting text below as a natural lead-in
             ...
             <div class="col-sm-12">
                 ...
                 <div class="row" data-masonry='{"percentPosition": true }'>
                     ...
                     <div class="col-sm-6 col-lg-4">
                         <div class="card mb-3">
                             <img src="{{ asset('images/page-img/card.jpg') }}" class="card-img-top rounded"
                                 alt="#" loading="lazy">
                         </div>
                     </div>
                     <div class="col-sm-6 col-lg-4">
