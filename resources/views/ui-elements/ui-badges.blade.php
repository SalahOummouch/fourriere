        ...
        <div class="col-sm-12 col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h6 class="mb-0 mt-2">Example heading <span class="badge bg-info">New</span></h6>
            </div>
          </div>
          <div class="card">
            <div class="card-header d-flex justify-content-between">
        ...
        <div class="col-sm-12 col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <span class="mt-2 badge bg-light text-white">Light</span>
              ...
              <span class="mt-2 badge rounded-pill bg-light text-white">Light</span>
              ...
              <a href="#" class="mt-2 badge bg-light text-white">Light</a>
