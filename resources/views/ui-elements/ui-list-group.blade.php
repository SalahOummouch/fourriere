   ...
   <div class="row">
         ...
         <div class="card">
            ...
            <div class="card-body">
               <p>Add badges to any list group item to show unread counts, activity, and more with the help of some <a
                     href="https://getbootstrap.com/docs/5.3/utilities/flex">utilities</a>.</p>
               <ul class="list-group">
      ...
      <div class="col-sm-12 col-lg-6">
         <div class="card">
            ...
            <div class="card-body">
               <p>Add <code>.active</code> to a <code>.list-group-item</code> to indicate the current active selection.
               </p>
               <ul class="list-group">
