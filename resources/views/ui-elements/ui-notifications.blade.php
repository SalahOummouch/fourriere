      ...
      <div class="col-lg-6">
         <div class="card">
            ...
            <div class="card-body">
               <p>Toasts are slightly translucent, too, so they blend over whatever they might appear over. For browsers
                  that support the <code>backdrop-filter</code> CSS property, we’ll also attempt to blur the elements
                  under a toast.</p>
               <div class="p-3 bg-dark">
                  <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                     <div class="toast-header">
         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <p class="mt-3">For systems that generate more notifications, consider using a wrapping element so they
                  can easily stack.</p>
         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <div class="d-flex flex-wrap justify-content-around">
                  <div class="toast fade show bg-primary text-white  mt-3" role="alert" aria-live="assertive"
                     aria-atomic="true">
                  ...
                  <div class="toast fade show bg-success text-white  mt-3" role="alert" aria-live="assertive"
                     aria-atomic="true">
