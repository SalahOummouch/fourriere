         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <div class="row mt-4">
                  ...
                  <div class="col-lg-2 col-md-6 text-center mb-4 mb-lg-0">
         ...
         <div class="card">
            ...
            <div class="card-body">
               <p>Similar to the contextual text color classes, easily set the background of an element to any
                  ...
                  <code>.text-*</code> utilities.</p>
               <div class="row mt-4">
                  <div class="col-lg-2 col-md-6 text-center mb-3 mb-md-0">
                  ...
                  <div class="col-lg-2 col-md-6 text-center mb-3 mb-md-0">
                     <p class="bg-dark-subtle text-gray pt-5 pb-5 text-center rounded font-size-18">Dark</p>
                  </div>
         ...
         <div class="card">
            ...
            <div class="card-body">
               <p>Contextual text classes also work well on anchors with the provided hover and focus states.
                  <strong>Note that the <code>.text-white</code> and <code>.text-muted</code> class has no additional
                     link styling beyond underline.</strong></p>
               ...
               <p class="text-black-50 bg-secondary">.text-black-50</p>
      ...
      <div class="col-lg-6">
         <div class="card">
            ...
            <div class="card-body">
               ...
               <p class="bg-dark-subtle text-gray ps-3 pe-3 pt-2 pb-2 rounded">Dark link</p>
      ...
      <div class="col-lg-6">
         <div class="card">
            ...
            <div class="card-body">
               ...
               <p><a href="#" class="bg-secondary-subtle ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Secondary link</a>
               </p>
               ...
               <p class=""><a href="#" class=" bg-dark-subtle text-gray ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Dark
                     link</a></p>
               <p class="mb-0"><a href="#" class="bg-gray-subtle ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Gray
                     link</a></p>
            </div>
         </div>
      </div>
