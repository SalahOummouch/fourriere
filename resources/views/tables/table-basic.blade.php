                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Similar to tables and dark tables, use the modifier classes <code
                            ...
                            to make <code class="highlighter-rouge">&lt;thead&gt;</code>s appear light or dark gray.</p>
                        <table class="table">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr class="table-primary basic-table-text">
                    ...
                    <div class="card-body">
                        <p>Responsive tables allow tables to be scrolled horizontally with ease. Make any table
                            ...
                            all viewports by wrapping a <code class="highlighter-rouge">.table</code> with <code
                                class="highlighter-rouge">.table-responsive</code>. Or, pick a maximum breakpoint with
                            which to
                            have a responsive table up to by using <code
                                class="highlighter-rouge">.table-responsive{-sm|-md|-lg|-xl|-xxl}</code>.</p>
