                    ...
                    <ul class="navbar-nav ms-auto navbar-list align-items-center">
                        ...
                        <li class="nav-item nav-icon dropdown">
                            ...
                            aria-expanded="false">
                                ...
                                <img src="{{ asset(Auth::user()->avatar ?? 'images/user/1.jpg') }}" class="img-fluid avatar-rounded" alt="user">
                                <!-- Affichage du nom de l'utilisateur connecté -->
                                <span class="mb-0 ms-2 user-name">{{ Auth::user()->username }}</span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="{{ route('account s.edit', ['user' => Auth::user()->id]) }}">Mon profil</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="{{ route('userprofileedit') }}">Modifier Profil</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="{{ route('useraccountsetting') }}">Paramètre de compte</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="{{ route('userprivacysetting') }}">Paramètre privé</a>
                                </li>
