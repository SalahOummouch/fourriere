<x-app-layout>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 mb-3 d-flex justify-content-between">
            <h4 class="fw-bold d-flex align-items-center">Edit Customer</h4>
        </div>
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="card-body rounded bg-light">
                                <div class="d-flex justify-content-center">
                                     <!-- <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        height="80px" x="0px" y="0px" viewBox="0 0 419.2 419.2"
                                ...
                                <div class="d-flex justify-content-center mt-2 mb-3">
                                    ...
                                    <p class="mb-0 text-muted fw-bold">Upload Image</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <form class="row g-3 date-icon-set-modal">
                                <div class="col-md-6 mb-3">
                                    <label for="Text1" class="form-label fw-bold text-muted text-uppercase">Full
                                        Name</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label
                                        class="form-label fw-bold text-muted text-uppercase mb-md-3 mb-1">Gender</label><br>
                                    ...
                                    <div class="form-check form-check-inline mt-2 ps-md-3">
                                        <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <div class="col-md-6 mb-3  position-relative">
                                    <label for="Text2" class="form-label fw-bold text-muted text-uppercase">Birth
                                        Day</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="Text3" class="form-label fw-bold text-muted text-uppercase">Company
                                        Name</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="Text4"
                                        class="form-label fw-bold text-muted text-uppercase">Email</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="inputState"
                                        class="form-label fw-bold text-muted text-uppercase">Country</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="inputState"
                                        class="form-label fw-bold text-muted text-uppercase">State/Region</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="Text7"
                                        class="form-label fw-bold text-muted text-uppercase">Zipcode</label>
                                    <input type="text" class="form-control" id="Text7" placeholder="Enter Zipcode"
                                        value="43201">
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label for="Text9" class="form-label fw-bold text-muted text-uppercase">Bio</label>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label class="form-label fw-bold text-muted text-uppercase mb-3">Notification
                                        Type</label><br>
                                    <div class="form-check form-check-inline">
                            ...
                            <div class="d-flex flex-wrap justify-content-between mt-3 gap-3">
                                ...
                                <button class="btn btn-primary fw-bold btn-sm">
                                    Save Customer
                                </button>
                            </div>
                        </div>
